        ...
        htmlContent: `
          <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; background: white; color: #333;">
            ...
            <div style="padding: 40px 32px 32px 32px; background: white;">
              ...
              <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 12px; margin: 20px 0; max-width: 100%;">
                <img src="${baseUrl}/lovable-uploads/ejemplos-sonrisas.png" alt="Ejemplo Sonrisas" style="width: 100%; height: auto; border-radius: 8px; border: 1px solid #e5e7eb;">
                <img src="${baseUrl}/lovable-uploads/ejemplos-ate.png" alt="Ejemplo ATE" style="width: 100%; height: auto; border-radius: 8px; border: 1px solid #e5e7eb;">
                <img src="${baseUrl}/lovable-uploads/ejemplos-colegio.png" alt="Ejemplo Colegio" style="width: 100%; height: auto; border-radius: 8px; border: 1px solid #e5e7eb;">
                <img src="${baseUrl}/lovable-uploads/ejemplos-ecopartner.png" alt="Ejemplo EcoPartner" style="width: 100%; height: auto; border-radius: 8px; border: 1px solid #e5e7eb;">
                <img src="${baseUrl}/lovable-uploads/ejemplos-gatitos.png" alt="Ejemplo Gatitos" style="width: 100%; height: auto; border-radius: 8px; border: 1px solid #e5e7eb;">
                <img src="${baseUrl}/lovable-uploads/ejemplos-lux.png" alt="Ejemplo Lux" style="width: 100%; height: auto; border-radius: 8px; border: 1px solid #e5e7eb;">
                <img src="${baseUrl}/lovable-uploads/ejemplos-propiedades.png" alt="Ejemplo Propiedades" style="width: 100%; height: auto; border-radius: 8px; border: 1px solid #e5e7eb;">
                <img src="${baseUrl}/lovable-uploads/ejemplos-taxi.png" alt="Ejemplo Taxi" style="width: 100%; height: auto; border-radius: 8px; border: 1px solid #e5e7eb;">
                <img src="${baseUrl}/lovable-uploads/ejemplos-emprendedora.png" alt="Ejemplo Emprendedora" style="width: 100%; height: auto; border-radius: 8px; border: 1px solid #e5e7eb;">
                <img src="${baseUrl}/lovable-uploads/ejemplos-artetransfer.png" alt="Ejemplo Arte Transfer" style="width: 100%; height: auto; border-radius: 8px; border: 1px solid #e5e7eb;">
                <img src="${baseUrl}/lovable-uploads/ejemplos-dojo.png" alt="Ejemplo Dojo" style="width: 100%; height: auto; border-radius: 8px; border: 1px solid #e5e7eb;">
                <img src="${baseUrl}/lovable-uploads/ejemplos-tenis.png" alt="Ejemplo Tenis" style="width: 100%; height: auto; border-radius: 8px; border: 1px solid #e5e7eb;">
              </div>
