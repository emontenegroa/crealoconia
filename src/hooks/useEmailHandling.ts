...
Cuando el usuario te pida contenido, genera ideas específicas, textos completos y estrategias accionables.
      ...
      if (enhanceError) {
        console.error('❌ Error mejorando contenido:', enhanceError);
        // Si falla ChatGPT, enviamos el contenido base
      }
