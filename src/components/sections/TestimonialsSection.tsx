...
const TestimonialsSection = () => {
  ...
  return <section className="py-32 bg-gradient-to-br from-background to-muted/20 relative overflow-hidden">
      {/* Background Effects */}
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-accent rounded-full blur-3xl animate-float" />
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-primary rounded-full blur-3xl animate-float" style={{
        animationDelay: '3s'
      }} />
      </div>
      ...
      <div className="container mx-auto px-4 max-w-6xl relative z-10">
        <ScrollAnimation>
          <div className="text-center mb-20">
            <h2 className="font-heading text-4xl md:text-6xl font-bold text-primary mb-6">Referencias</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {testimonials.map((testimonial, index) => <ScrollAnimation key={index} delay={index * 200}>
                ...
                <CardContent className="p-8">
                  ...
                  <div className="flex items-center gap-4 mb-6">
                    <div className="relative">
                      <img src={testimonial.image} alt={testimonial.name} className="w-16 h-16 rounded-full object-cover border-2 border-accent/30 shadow-lg group-hover:scale-110 transition-transform duration-500" />
                  ...
                  {/* CTA Button */}
                  <Button variant="ghost" size="sm" className="font-accent font-medium hover:bg-accent/10 hover:text-accent transition-all duration-300">
                    Ver sitio →
                  </Button>
                </CardContent>
              </Card>
