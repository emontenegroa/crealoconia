          ...
          {Array.from({ length: totalSteps }, (_, index) => {
            ...
            return (
              <div key={index} className="flex items-center">
                <div className={`
                  w-7 h-7 md:w-8 md:h-8 rounded-full flex items-center justify-center transition-all duration-300 flex-shrink-0
                  ${isCompleted 
                ...
                {index < totalSteps - 1 && (
                  <div className={`
                    w-4 h-1 md:w-6 md:h-1 mx-1 transition-all duration-300 flex-shrink-0
