...
const MainForm = ({
  ...
  return <Card className="max-w-4xl mx-auto bg-white border-gray-200 shadow-xl" id="main-form">
      <CardHeader className="text-center pb-8 bg-gray-50 border-b border-gray-200">
        ...
        <div className="mt-6 space-y-2 text-gray-700">
          <p className="flex items-center justify-center gap-2">
            ⏱️ <strong>Tiempo: 3-7 minutos</strong>
          </p>
          <p className="flex items-center justify-center gap-2">
        ...
        {/* Botón de prueba */}
        <div className="mt-6">
          <Button type="button" onClick={onLoadExample} variant="outline" className="border-gray-300 text-gray-700 hover:bg-gray-50">
      ...
      <CardContent className="p-8 bg-white">
        <form onSubmit={onSubmit} className="space-y-8">
          ...
          <Button type="submit" className="w-full py-4 sm:py-6 text-sm sm:text-base lg:text-lg font-semibold bg-blue-600 hover:bg-blue-700 text-white shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300" disabled={!isFormValid}>
