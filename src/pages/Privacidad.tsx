      ...
      <main className="container mx-auto max-w-3xl px-6 py-16">
        ...
        <section className="space-y-8 text-base leading-relaxed">
          <div>
            ...
            <p className="mt-1">Contacto: <a href="mailto:hola@crealoconia.com" className="text-primary underline">hola@crealoconia.com</a></p>
          </div>
          ...
          <div>
            ...
            <p>Tienes derecho a acceder, rectificar, cancelar u oponerte al tratamiento de tus datos. Escríbenos a <a href="mailto:hola@crealoconia.com" className="text-primary underline">hola@crealoconia.com</a> — respondemos en máximo 15 días hábiles.</p>
          </div>
