...
const ResultadosPrueba = () => {
  ...
  // Intentar obtener los datos reales del formulario desde sessionStorage
  const getFormDataFromStorage = () => {
    try {
      const storedData = sessionStorage.getItem('completedFormData');
      if (storedData) {
    ...
    // Si no hay datos reales, usar datos de ejemplo como fallback
    return {
